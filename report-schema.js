...
const REPORT_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'siteDrainage', label: 'Site drainage appears to be generally', type: 'select', options: ['Adequate', 'Inadequate'], aiFillable: true },
      { id: 'subfloorDrainage', label: 'Subfloor drainage appears to be generally', type: 'select', options: ['Adequate', 'Inadequate', 'Not applicable'], aiFillable: true },
      { id: 'ventilation', label: 'At the time of inspection, ventilation appeared to be', type: 'select', options: ['Adequate', 'Inadequate'], aiFillable: true },
      { id: 'antCappingCondition', label: 'Termite shields (ant capping) appear to be', type: 'select', options: ['Adequate', 'Inadequate', 'Not present'], aiFillable: true },
      ...
      { id: 'weepHolesClear', label: 'Weep holes are clear and visible', type: 'yesno', aiFillable: true },
    ],
  },
  {
    id: 'terms',
